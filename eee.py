	...
	def __login__(self):
		...
		if token in ['']:
			...
			try:
				...
				self.takon()
	def takon(self):
		takon = input('\n %s[%s>_%s] MAU\x1b[38;5;46m PREMIUM \x1b[38;5;231mY/T : \x1b[38;5;46m'%(N,O,N))
		if takon in ['y','Y','iya']:
			jalan('\n %s[%s>_%s] KAMU AKAN DI ARAHKAN KE ADMIN BOCIL GOBLOK'%(N,O,N))
